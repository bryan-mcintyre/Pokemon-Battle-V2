...
- **WHEN** I choose catch Pokémon
  - **THEN** I am able to use a Pokéball to add the Pokémon to my collection
- **WHEN** I lose
...
[Pokemon-Battle-V2 Repository](https://github.com/iKeyToLife/Pokemon-Battle-V2)

## Deployed Application

[Pokemon-Battle-V2 Application](https://pokemon-battle-bfgc.onrender.com)
